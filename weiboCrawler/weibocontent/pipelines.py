...
import codecs
import pymongo
from weibocontent.settings import MONGO_COLL
from weibocontent.settings import MONGO_DB
from weibocontent.settings import MONGO_HOST
from weibocontent.settings import MONGO_PORT

# 定义数据输出方式
class WeibocontentPipeline(object):
...
#     # 初始化连接
#     def __init__(self):
#         self.conn = MySQLdb.connect(user='root', passwd='199628', db='weibo', host='localhost',port=3306, charset="utf8", use_unicode=True)
